...
export const TechStack = () => {
  ...
  const t = lang === 'uk' 
    ? { badge: "09 // Стек", title: "Python + JavaScript" }
    : { badge: "09 // Tech Stack", title: "Python + JavaScript" };
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
          {stack.map((tech, i) => (
            <motion.div
              ...
              className="p-6 border border-white/10 bg-graphite rounded-xl hover:border-beige-500/30 transition-colors group"
            >
              <div className="w-12 h-12 rounded-xl bg-beige-500/10 border border-beige-500/20 flex items-center justify-center mb-4 text-beige-500 group-hover:bg-beige-500/20 transition-colors">
